---
name: blackboard-path
description: Blackboard 데이터 경로 가이드. 데이터 경로 확인, 값 위치, Blackboard 관련 작업 시 자동으로 사용됨.
trigger: Blackboard, 데이터 경로, 값 위치 관련 작업 시
priority: medium
---
...
- "Blackboard 경로", "데이터 경로 알려줘" 요청 시
- "값 어디있어", "응답 데이터 위치" 요청 시
- Blackboard 관련 작업 시
