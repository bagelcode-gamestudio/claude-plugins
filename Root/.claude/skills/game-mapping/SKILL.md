---
name: game-mapping
description: 게임 ID 매핑 가이드. 게임 ID, 보너스 ID, 파일 위치 확인 시 자동으로 사용됨.
trigger: 게임 ID, bonusId, 게임 찾기, 게임 매핑 관련 작업 시
priority: medium
---
...
| 스킬 | 용도 |
|------|------|
| `bonus-flow` | 보너스 ID 활용 |
| `schema-sync` | Schema.json 동기화 |
